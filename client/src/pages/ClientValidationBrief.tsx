...
const COPY: Record<Language, Copy> = {
  en: {
    ...
    approvalValue: "Complete a six-question OTM suitability check",
    title: "Before considering OTM, answer six questions to assess whether it fits your transportation needs and is worth further evaluation.",
    subtitle: "This is a quick suitability check — not an enterprise deployment decision.",
    ...
    dataTitle: "Enough to assess fit. Not yet enough to approve an investment case.",
  ...
  zh: {
    ...
    approvalValue: "完成六题 OTM 适配性检查",
    title: "在进一步评估 OTM 之前，先回答六个问题，看看它是否符合你的运输需求，是否值得继续评估。",
    subtitle: "这是一项快速适配性检查，而不是企业级部署决策。",
    factKicker: "为什么从这里开始",
    ...
    dataKicker: "数据位置",
    dataTitle: "足以开始评估适配性；尚不足以批准投资案例。",
  ...
  es: {
    ...
    approvalValue: "Completar un check de seis preguntas sobre la adecuación de OTM",
    title: "Antes de considerar OTM, responda seis preguntas para evaluar si se ajusta a sus necesidades de transporte y merece una evaluación posterior.",
    subtitle: "Es un check rápido de adecuación, no una decisión de despliegue empresarial.",
    ...
    dataTitle: "Suficiente para evaluar la adecuación. Aún no para aprobar un caso de inversión.",
