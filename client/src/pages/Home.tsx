      ...
      <main className="page-main">
        <section className="hero" id="overview">
          ...
          <div className="hero-content">
            ...
            <p className="hero-copy">{language === "zh" ? "用 OTM、GTM 能力、你自己的运营资料、价值估算方法和决策线索，逐步弄清哪里值得继续探索。" : language === "es" ? "Use capacidades OTM y GTM, sus propios datos operativos, métodos de estimación de valor y señales de decisión para aclarar qué vale la pena explorar." : "Use OTM and GTM capabilities, your own operating information, value-estimation methods, and decision signals to clarify what is worth exploring."}</p>
