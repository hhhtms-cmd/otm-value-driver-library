...
- [x] 审计首屏档案编号与资料区，明确删除纯装饰编号、保留任务上下文并折叠静态说明。
- [x] 设计“默认做任务、需要时再看资料”的客户信息层级和折叠交互。
- [x] 删除首屏 FILE 编号与非必要编号，重构资料清单为按需展开参考，不改变已完成任务。
- [x] 验证桌面和手机端可完成任务、展开资料和页面无冗余编号／文字重叠。
- [x] 保存并发布更简洁、任务优先的 Decision Archive。
